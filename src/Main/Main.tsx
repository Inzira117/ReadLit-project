  ...
  const handleSearch = async (query: string) => {
    ...
    return (
        <main className="main">
            ...
            <p className="p text-light">“A reader lives a thousand lives before he dies. The man who never reads lives only one.” <span className="span">— George R.R. Martin</span></p>
            </div>
